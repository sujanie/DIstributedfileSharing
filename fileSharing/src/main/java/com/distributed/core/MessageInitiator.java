...
import com.distributed.services.UDPClient;
import com.distributed.services.UDPServer;
...
import com.distributed.handlers.AbstractResponseHandler;
import com.distributed.handlers.LeaveHandler;
import com.distributed.handlers.PingHandler;
import com.distributed.handlers.ResponseHandlerFactory;
import com.distributed.handlers.SearchQueryHandler;
import com.distributed.handlers.TimeoutCallback;

public class MessageInitiator extends Thread {

    private final Logger LOG = Logger.getLogger(MessageInitiator.class.getName());
    ...
    public MessageInitiator(String address, int port) throws SocketException {
    ...
    public boolean addFile(String fileName) {
    	return this.fileManager.addFile(fileName, "");
    }
