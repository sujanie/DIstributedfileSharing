...
public class UIController extends Thread implements Initializable {
  ...
  @FXML
    ...
    @FXML
    private TableColumn<SearchResultView,  String> nodeid;
            ...
            if (resultsCount == 0){
               // areaSearch.setText("Sorry, no files found");
                ...
                for(SearchResult s : results){
                	searchlist.add(new SearchResultView(optionNo, s.getFileName(), s.getAddress(), s.getPort(),String.valueOf(s.getTimeElapsed())+"ms"));
                    optionNo++;
                }
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		...
		sid.setCellValueFactory(new PropertyValueFactory<SearchResultView,String>("id"));
		...
		nodeid.setCellValueFactory(new PropertyValueFactory<SearchResultView,String>("nodeID"));
